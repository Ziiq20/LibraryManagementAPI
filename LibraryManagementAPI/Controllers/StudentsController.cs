...
using LibraryManagementAPI.Data; // Adjust namespace to match your project
using LibraryManagementAPI.Models; // Adjust namespace to match your project
...
namespace LibraryManagementAPI.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentName,DOB,Email")] Student student)
        {
        ...
        [HttpPost("Edit/{id}")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentID,StudentName,DOB,Email")] Student student)
        {
